const StackLoader = () => {
  return (
    <div className="card">
      <div className="group relative flex aspect-video w-[70px] rotate-[30deg] items-center justify-center bg-red-500 transition-all duration-700 sm:w-[150px]">
        <div className="absolute flex h-full w-full flex-col items-center justify-start bg-[#00ccbf] py-2 transition-all duration-300 group-hover:-translate-y-16 group-hover:duration-1000">
